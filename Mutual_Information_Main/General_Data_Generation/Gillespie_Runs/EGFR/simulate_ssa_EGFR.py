from Mutual_Information_Main.functions.Models.EGFR import model
import numpy as np
...
if __name__ == '__main__':
	...
	params_file_path = Path("Data/EGFR/Model_Params/noise_factor_1/params_226.npy")
	# Specifies path to output directory
	output_folder = Path("Data/EGFR/Gillespie_Results/")
	...
	# scales synthesis rate, converting from a.u. to protein levels
	params[:, 0] /= 0.00122
