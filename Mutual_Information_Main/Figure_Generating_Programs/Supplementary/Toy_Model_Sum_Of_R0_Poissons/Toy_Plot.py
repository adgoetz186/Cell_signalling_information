...
output_path = Path("Figures/Supplementary/sum_of_toy_responses_R0/")

# name of output image
output_name = "sum_of_toy_responses_R0"
...
sc_crm_list = tmf.pxgut_r0(ulist,r0_variance,r0_mean,mc_draws,k_deg,k_bind,k_unbind,5)
xlist = np.arange(r0_mean*5)
