...
dose_response_dir = Path("Data/EGFR/Experimental_Values/EGFR_data_10cond_scaled_dict.npy")

# Specifies output path
output_path = Path("Figures/Supplementary/EGFR_Expt_Dose_Resp")

# Specifies output name
output_name = "dose_response"
